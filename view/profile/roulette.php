...
<body class="roulette-page">
	...
	<div class="container-fluid">
        ...
        <div class="row justify-content-md-center">
            <div class="col-md-auto">
				...
				<div class="balance">Баланс: <b id="balance"><?php echo $data[$ucp_table_settings['donate']] ?></b> грн.</div><br>
				    <div class="roulette" >
    ...
    <div style="text-align: center;">
 	...
 	<?php else:?>
    <button class="button-roullet" id="go-roullet">Крутити за <b><?php echo $ucp_settings['s_donate_cost'] ?></b> грн.</button>
<?php endif;?>
