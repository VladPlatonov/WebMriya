				...
				<div class="row">
							...
							<div class="col-md-6">
								<div class="panel panel-default card-view">
									<div class="panel-heading">
										<div class="pull-left">
											<h6 class="panel-title txt-dark">Зміна паролю</h6>
										</div>
						...
						<div class="col-md-6">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Подати заявку в White List</h6>
									</div>
									<div class="clearfix"></div>
								</div>
								<div class="panel-wrapper collapse in">
					...
					Подайте заявку в White List чтобы создавать персонажей! </div>' ):?>
											...
											<form  method="POST" action="/engine/obr/profile.php">
												...
												<div class="form-group mb-10">
														...
														<div class="form-group mb-0">
															<div class=" col-sm-12">
																<button type="submit" class="btn btn-block  btn-success">Прийняти</button>
															</div>
														</div>
