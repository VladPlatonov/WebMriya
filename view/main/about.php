...
<body >
    ...
    <div class="container">
        <div class="row">	
            <div class="col-lg-12">
            Надокучили однотипні сервери SA:MP?
            Хочеться свободи та нового ігрового досвіду?
            Нової економіки та цікавого функціонала?
            Приєднуйся до нашого ентузіастського проєкту. Можливо, нам не вистачає саме тебе!
            Приємної гри!
            У нас ти зможеш відчути всю атмосферу української гри та українських гравців!
            Повноцінний онлайн-симулятор реального життя з режимом open-world, можлива гра прямо на твоєму смартфоні.
            Ми - команда ентузіастів, що працює над цим проектом. Від нас однозначно можете очікувати відповідальність, організованість, згуртованість та оперативність. Однією з головних наших навичок - наполегливість та активність. Розробляючи проект "mriya role play" ми в першу чергу орієнтуємось на гравців та атмосферу рольової гри.
            <br>
            <br>
            <br>
            <br>
