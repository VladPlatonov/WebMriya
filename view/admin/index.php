...
<!DOCTYPE html>
<html class="loading" lang="ua" data-textdirection="ltr">
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
  <title>Головна - Admin - <?php echo $ucp_settings['s_title']?></title>
...
<div class="app-content content">
          ...
          <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="basic-layout-tooltip">Налаштування UCP</h4>
                  ...
                  <div class="card-body">
                    ...
                    <form class="form" method="POST" action="/engine/obr/admin.php">
                      <div class="form-body">
                        ...
                        <div class="form-group">
                          <label for="issueinput2">Ціна рулетки</label>
                      ...
                      <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-primary">
                          <i class="fa fa-check-square-o"></i> Зберегти
                        </button>
                      </div>
                    </form>
                  </div>
  ...
  <footer class="footer footer-static footer-light navbar-border">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">Copyright &copy; 2023 <?php echo $ucp_settings['s_title']?>, All rights reserved. </span>
