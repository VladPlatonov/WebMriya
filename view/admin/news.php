...
<head>
  ...
  <title>Новини - Admin - <?php echo $ucp_settings['s_title']?></title>
                              ...
                              <div class="modal-content">
                                ...
                                <form method="POST" action="/engine/obr/admin.php">
                                  ...
                                  <div class="row">
			                          ...
			                          <div class="col-lg-12">
			                            <div class="form-group">
			                              <label for="projectinput2">Ссилка на картинку</label>
			                          ...
			                          <div class="col-lg-12">
			                            <div class="form-group">
			                              <label for="projectinput2">Ссилка на новину</label>
			                          ...
			                          <div class="col-lg-12">
			                          	<div class="form-group">
				                          <label for="projectinput8">Короткий опис</label>
